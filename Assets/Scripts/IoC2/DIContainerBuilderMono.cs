...
public class DIContainerBuilderMono : MonoBehaviour
{
  [SerializeField] private List<ServiceDescriptor> _serviceDescriptors = new List<ServiceDescriptor>();

  private void Awake()
  {
    DIContainer container = GenerateContainer();
  }
